...
const projects = [
  ...
  },
  {
    ...
    description: 'This website monitors the air quality in Denver, CO. It provides open source weather data such as API and pollutant levels. If AQI levels exceed 100 and someone visits the site, the level determined at which air quality begins to effect human health at all ages, an email is sent to our state government representatives with information on air quality, and how they can make efforts to improve air quality for Colorado residents. This was accomplished using Nodemailer, an npm package. The site also serves as a general informational hub regarding air quality in general.',
